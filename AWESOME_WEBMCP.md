...
- [**Contoso Pizza**](https://github.com/MicrosoftEdge/webmcp-labs/tree/main/demos/pizza-order) ([live](https://microsoftedge.github.io/webmcp-labs/pizza-order/)): A pizza-ordering demo by Microsoft Edge with WebMCP tools for browsing the menu, creating and updating an order, and checking out.
