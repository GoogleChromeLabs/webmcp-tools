...
- [**Report Exporter (Imperative)**](demos/abort-report/): A long-running report export that an agent can cancel mid-flight, showing how a tool receives an `AbortSignal` and stops its work.
